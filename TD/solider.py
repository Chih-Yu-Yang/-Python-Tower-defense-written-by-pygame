...
'''
        ...
        self.islive=1
        self.__move=40
        self.__hp=int(lv_Table.soliderHPbasic*(lv_Table.soliderHPrate**self.__lv))
        self.__attack=int(lv_Table.soliderAttackbasic*(lv_Table.soliderAttackrate**self.__lv))
