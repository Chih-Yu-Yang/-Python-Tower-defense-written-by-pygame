...
'''
        ...
        self.islive=1
        self.__move=30
        self.__hp=int(lv_Table.archerHPbasic*(lv_Table.archerHPrate**self.__lv))
        self.__attack=int(lv_Table.archerAttackbasic*(lv_Table.archerAttackrate**self.__lv))
